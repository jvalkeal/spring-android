...
package org.springframework.cache.lru;
...
public class LruCache implements Cache {
    ...
    public LruCache(String name, int maxSize) {
        this(name, maxSize, true,  new android.util.LruCache(maxSize));
    }
     ...
     */
    public LruCache(String name, int maxSize, boolean allowNullValues, android.util.LruCache cache) {
        mName = name;

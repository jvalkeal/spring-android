 ...
 * dispatchers that may try multiple handler invocations within a single
 * dispatch operation.
 * 
 * @author Mark Fisher
 */
...
public class AggregateMessageDeliveryException extends MessageDeliveryException {
    ...
    public AggregateMessageDeliveryException(Message<?> undeliveredMessage, String description,

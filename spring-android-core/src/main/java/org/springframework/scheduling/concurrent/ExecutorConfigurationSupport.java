...
public abstract class ExecutorConfigurationSupport extends CustomizableThreadFactory
    ...
    private final static String TAG = "ExecutorConfigurationSupport";
	...
	public void initialize() {
		if (LogConstants.DEBUG) {
			Log.i(TAG, "Initializing ExecutorService " + (this.beanName != null ? " '" + this.beanName + "'" : ""));
		}
	...
	public void shutdown() {
		if (LogConstants.DEBUG) {
		    Log.i(TAG, "Shutting down ExecutorService" + (this.beanName != null ? " '" + this.beanName + "'" : ""));
		}
